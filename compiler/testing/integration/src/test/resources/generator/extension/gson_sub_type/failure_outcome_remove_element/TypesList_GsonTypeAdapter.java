...
public final class TypesList_GsonTypeAdapter extends GsonPathTypeAdapter<TypesList> {
    ...
    private StrictArrayTypeAdapter getItemsGsonSubtype() {
        if (itemsGsonSubtype == null) {
            itemsGsonSubtype = new StrictArrayTypeAdapter<>(new ItemsGsonSubtype(gson), Type.class, true);
        }
    ...
    public String getModelClassName() {
        return "generator.extension.gson_sub_type.failure_outcome_remove_element.TypesList";
    }
